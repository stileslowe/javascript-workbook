...
function movePiece(startStack, endStack) {
  ...
  const startPop = activeStacks[startStack].pop();
  console.log(startPop);
  const endPush = activeStacks[endStack].push(startPop);
  console.log(endPush);
...
function towersOfHanoi(startStack, endStack) {
  ...
  if (checkForWin(activeStacks)) { //if won, set stacks back to original stacks.
